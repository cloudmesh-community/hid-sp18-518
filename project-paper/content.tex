...
\keywords{hid-sp18-517, hid-sp18-402, hid-sp18-518, libcloud}


\maketitle

\section{RESTful API service to enable ease of portability leveraging libcloud}\label{restful-api-service-to-enable-ease-of-portability-leveraging-libcloud}
