...
one-stop solution.
A high-level architecture of the concept along with functions is shown in
Figure~\ref{F:arch}.
...
We have used layred approach so that any new implementation can be integrated easily into
the solution. Figure~\ref{F:layerd-arch} describes layred architecture used for this service.
