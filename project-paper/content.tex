...
Botocore itself is driven by JSON blobs that define the feature and its use. This concept 
...
Function & Description & Command\\
 \hline
 Driver	& How to choose the primary cloud provider that will be used by other functions	& libcloud.get\_driver()\\
  \hline
 \end{tabular}
 \end{table}
